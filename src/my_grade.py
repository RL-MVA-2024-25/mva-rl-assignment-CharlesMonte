...
def global_test():
    test_values = {}
    test_values['agent-performance-1'] = test_expected_result_one_env_3432807()
    test_values['agent-performance-2'] = test_expected_result_one_env_1e8()
    test_values['agent-performance-3'] = test_expected_result_one_env_1e9()
    test_values['agent-performance-4'] = test_expected_result_one_env_1e10()
    test_values['agent-performance-5'] = test_expected_result_one_env_2e10()
    test_values['agent-performance-6'] = test_expected_result_one_env_5e10()
    test_values['agent-dr-performance-1'] = test_expected_result_dr_env_1e10()
    test_values['agent-dr-performance-2'] = test_expected_result_dr_env_2e10()
    test_values['agent-dr-performance-3'] = test_expected_result_dr_env_5e10()
    
    print(test_values)
    print(sum(test_values.values()), 'out of 9 tests passed')
    return test_values
